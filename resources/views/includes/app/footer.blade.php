     ...
     <div class="container text-center text-md-start mt-5">
         ...
         <div class="row mt-3">
             ...
             <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-md-0 mb-4">
                 ...
                 <hr class="mb-4 mt-0 d-inline-block mx-auto"
                     style="width: 60px; background-color: #7c4dff; height: 2px" />
                 <p><i class="fas fa-home mr-3"></i> Susukan RT 002/003, Sumbang</p>
                 <p><i class="fas fa-envelope mr-3"></i> devadigitalprint@gmail.com</p>
                 <p><i class="fas fa-print mr-3"></i> 082243378269</p>
             </div>
             <!-- Grid column -->
         </div>
         <!-- Grid row -->
